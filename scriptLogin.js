...
let form = document.querySelector('.loginvalidator'); //Pegar o formulário que utilizaremos no código
form.addEventListener('submit', Loginvalidator.handleSubmit); //Monitoramento para validar quando tiver um 'submit'
